...
To run the code, you will need the dependencies in `pyproject.toml`. We recommend using uv:
...
└──  create_plot.py - helper to create the emission plots found in the report for task 6